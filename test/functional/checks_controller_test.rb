...
class ChecksControllerTest < ActionController::TestCase
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post :create, check: { priority: @check.priority, resultCode: @check.resultCode, resultText: @check.resultText, type: @check.type }
    end
  ...
  test "should update check" do
    put :update, id: @check, check: { priority: @check.priority, resultCode: @check.resultCode, resultText: @check.resultText, type: @check.type }
    assert_redirected_to check_path(assigns(:check))
  end
